...
use App\Http\Requests\MonsterExistsRequest;
...
class MonsterController extends Controller
{
     ...
     *
     */
    public function update(MonsterExistsRequest $request): JsonResponse
    {
     ...
     *
     */
    public function remove(MonsterExistsRequest $request): JsonResponse
    {
        $monsterId = $request->route('id');
        $result = $this->monsterService->getMonsterById($monsterId);
    ...
    {
        $data = $this->monsterService->getAllMonsters();
        return response()->json(compact('data'), Response::HTTP_OK);
    }

    public function show(MonsterExistsRequest $request): JsonResponse
    {
        $monsterId = $request->route('id');
        $mosnter = $this->monsterService->getMonsterById($monsterId);

        return response()->json([
            'data' => $mosnter->attributesToArray()
        ], Response::HTTP_OK);
    }
}
